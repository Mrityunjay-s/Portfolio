    ...
    >
      {cells.map((c, i) => (
        <span
          ...
          style={{
            // Matches the loader-sweep keyframe's own 0% colour — kept
            // theme-aware via the same --dot-rgb token dot-field.tsx reads,
            // rather than a literal that would stay light-grey after a
            // light-theme toggle.
