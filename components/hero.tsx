      ...
      >
        ...
        <div className="pointer-events-none relative z-10 mx-auto w-full max-w-350 px-5 pb-16 pt-32 sm:px-10">
          ...
          >
            ...
            Full Stack Engineer <span className="text-accent">
              &mdash;
            </span>{" "}
            Spring Boot <span className="text-accent">&middot;</span> React
            Native <span className="text-accent">&middot;</span> AI
          </motion.p>
...
<span className="block text-muted">
  between the <span className="text-foreground">request</span>
</span>
